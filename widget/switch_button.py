...
class SwitchControl(QWidget):
    ...
    def paintEvent(self, event: QPaintEvent):
        try:
            ...
            path.addRoundedRect(QRectF(self.m_nMargin,
                                       self.m_nMargin,
                                       self.width() - 2 * self.m_nMargin,
                                       self.height() - 2 * self.m_nMargin),
                                self.m_radius,
                                self.m_radius)
            ...
            painter.drawEllipse(QRectF(self.m_nX - (self.m_nHeight / 2),
...
class ExampleWidget(QWidget):
    ...
    def __init__(self, parent=None, *args):
        ...
        try:
            ...
            # self.switch_btn.setFixedSize(400, 80)
