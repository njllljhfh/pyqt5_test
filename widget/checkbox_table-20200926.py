...
class CheckBoxHeader(QHeaderView):
    ...
    def paintSection(self, painter, rect, logicalIndex):
        ...
        painter.restore()
        if logicalIndex == 0:
            print("rect.x() = {}".format(rect.x()))
            print("rect.y() = {}".format(rect.y()))
            print("rect.width() = {}".format(rect.width()))
            print("rect.height() = {}".format(rect.height()))
            print("rect.center() = {}".format(rect.center()))
            ...
            print("self._x = {}".format(self._x))
            print("self._y = {}".format(self._y))
            print("self._width = {}".format(self._width))
            print("self._height = {}".format(self._height))

            option = QStyleOptionButton()
            option.rect = check_box_rect
            print("check_box_rect.x() = {}".format(check_box_rect.x()))
            print("check_box_rect.y() = {}".format(check_box_rect.y()))
...
class BaseTableWidget(QTableWidget):
    ...
    def set_table_header_field(self, header_field: list, checkbox_side_length=16):
        """设置行表头字段"""
        try:
            # 表头字段，全局变量
            if self.has_header_checkbox:
                ...
                # 实例化自定义表头
                header = CheckBoxHeader(parent=self, checkbox_side_length=checkbox_side_length)
...
if __name__ == '__main__':
    ...
    class MyCheckboxTable(BaseTableWidget):
        ...
        def set_table_header_field(self, header_field: list, checkbox_side_length=16):
            super().set_table_header_field(header_field, checkbox_side_length=checkbox_side_length)
    ...
    # 设置表格行表头字段
    my_widget.check_box_table.set_table_header_field(header_field, checkbox_side_length=30)
