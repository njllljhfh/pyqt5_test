...
class BaseTableWidget(QTableWidget):
    ...
    def add_row_checkbox(self, row, row_checkbox: QCheckBox, row_checkbox_widget: QWidget):
        """
        为每一行的第一列添加复选框
        :param row: 行号
        ...
        # else:
        #     if row_checkbox in self.enabled_checkbox_ls:
        #         self.enabled_checkbox_ls.remove(row_checkbox)
        ...
        row_checkbox.clicked.connect(self.row_checkbox_clicked_event(row_checkbox))
    ...
    def update_header_checkbox_state(self):
        ...
        if self.has_header_checkbox:
            ...
            # elif 0 < len(self.selected_checkbox_ls) < self.rowCount():
            #     h_header.set_check_state(Qt.PartiallyChecked)
            # elif len(self.selected_checkbox_ls) == self.rowCount():
    ...
    def h_header_check_state_change_handler(self, check_state):
        ...
        try:
            ...
            if check_state == Qt.Unchecked:
                self.selected_checkbox_ls.clear()
                # for checkbox in self.all_checkbox_ls:
    ...
    def get_selected_data(self):
        ...
        enabled_row_ls.sort()
        print("可用行号列表 = {}".format(enabled_row_ls))
