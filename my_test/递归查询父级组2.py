...
if __name__ == '__main__':
    ...
    group_10 = Group(9, 10)
    group_11 = Group(11, 9)
    group_12 = Group(12, 11)
    obj_ls = [
        group_1,
        group_2,  # is a sub group of the group with group_id = 1
        group_3,  # is a sub group of the group with group_id = 1
        group_4,  # is a sub group of the group with group_id = 1
        group_5,  # is a sub group of the group with group_id = 1
        group_6,  # is a sub group of the group with group_id = 1
        group_7,
        group_8,
        group_9,  # is a sub group of the group with group_id = 1
        group_10,  # is a sub group of the group with group_id = 1
        group_11,  # is a sub group of the group with group_id = 1
        group_12,  # is a sub group of the group with group_id = 1
    ]
    ...
    # 假设用户的组是group_7,group_8
    # 组织上级组
    super_group_id_dict = {group_7.SUPER_GROUP_ID: dict()}  # 用户的第一层父级组
    ...
    group_data["super_group"].update(super_group_id_dict)

    super_group_id_dict = {group_8.SUPER_GROUP_ID: dict()}  # 用户的第一层父级组
    sub_group_data = [{key: super_group_id_dict[key]} for key in super_group_id_dict]
    recursion_retrieve(obj_ls, sub_group_data, is_sub_group=False)
    group_data["super_group"].update(super_group_id_dict)
    # - - -
    ...
    # 组织下级组
    super_group_id_dict = {group_7.GROUP_ID: dict()}  # 用户所在组
    sub_group_data = [{key: super_group_id_dict[key]} for key in super_group_id_dict]
    recursion_retrieve(obj_ls, sub_group_data, is_sub_group=True)
    group_data["sub_group"].update(super_group_id_dict)

    super_group_id_dict = {group_8.GROUP_ID: dict()}  # 用户所在的组
    sub_group_data = [{key: super_group_id_dict[key]} for key in super_group_id_dict]
    recursion_retrieve(obj_ls, sub_group_data, is_sub_group=True)
    group_data["sub_group"].update(super_group_id_dict)
    # t1 = time.time()
